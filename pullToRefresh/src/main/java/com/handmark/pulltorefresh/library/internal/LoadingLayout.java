...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	public LoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
		...
		iv_image_2= (ImageView) mInnerLayout.findViewById(R.id.iv_image_2);
	...
	public void showImage(boolean isShow) {
		if (isShow){
			mInnerLayout.setBackgroundResource(R.drawable.a_bg_refresh);
			iv_image_2.setVisibility(VISIBLE);
			...
			mInnerLayout.setBackgroundColor(Color.WHITE);
			iv_image_2.setVisibility(GONE);
		}
	}

	private OnShowImage onShowImage;
	private void setOnShowImage(OnShowImage onShowImage1){
