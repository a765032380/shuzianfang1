package com.bjxiyang.shuzianfang.myapplication.step.service;
...
import com.bjxiyang.shuzianfang.myapplication.step.accelerometer.StepCount;
...
//                    Intent intent1=new Intent(StepService.this, LaiDianActivity.class);
...
//                "new SimpleDateFormat(\"HH: mm\").format(new Date()))=" + new SimpleDateFormat("HH:mm").format(new Date()));
    ...
    private void updateNotification() {
        //设置点击跳转
        Intent hangIntent = new Intent(this, HomeActivity.class);
