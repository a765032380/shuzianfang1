...
import com.bjxiyang.shuzianfang.myapplication.zhifubao.PayResult;
...
//        fee=fee*100;
    ...
    private void initUI() {
        ...
        tv_zhifudingdan_time.setText(String.valueOf(df.format(fee)));
...
//        zhifu.setOnClickListener(this);
        ...
        tv_zhifudingdan_quedingzhifu.setText("确定支付  ￥"+ String.valueOf(df.format(fee)));
