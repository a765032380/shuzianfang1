...
import com.bjxiyang.shuzianfang.myapplication.activity.ZhiFuXiangQing;
...
public class WuYeJiaoFeiAdapter extends BaseAdapter {
    ...
    public WuYeJiaoFeiAdapter(Context mContext, List<WuYeJiaoFei.ObjBean> mList) {
...
//        viewHolder.tv_item_wuyejiaofei_zhifufangshi.setText(mList.get(position).getPaymentType());
        if (mList.get(position).getHavePayment()==0){
