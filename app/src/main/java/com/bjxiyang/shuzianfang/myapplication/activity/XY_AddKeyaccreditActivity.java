...
public class XY_AddKeyaccreditActivity extends MySwipeBackActivity implements View.OnClickListener {
    ...
    @BindView(R.id.add_select_zuke)
    LinearLayout add_select_zuke;
    @BindView(R.id.add_select_yezhu)
    LinearLayout add_select_yezhu;
    ...
    @BindView(R.id.ib_quedingtianjia)
    TextView ib_quedingtianjia;
    @BindView(R.id.ib_yezhujiashu)
    ImageButton ib_yezhujiashu;
    @BindView(R.id.ib_zuke)
    ImageButton ib_zuke;
    @BindView(R.id.select_xiaoqu)
    LinearLayout select_xiaoqu;
    @BindView(R.id.select_xiaoqu_tianjiashouquan)
    TextView select_xiaoqu_tianjiashouquan;
